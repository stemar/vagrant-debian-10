# Vagrant box Debian 10 LAMP

Make a Vagrant box with Debian 10 LAMP stack, plus configure it for development.

- Host: Linux or Mac.
- Guest: Debian 10, Apache 2.4, MariaDB 10.6, PHP 7.3, Python 2.7 & 3.7, Ruby 2.5, Git 2.x.
...
- 64bit Debian 10 virtual machine with virtual 64GB HDD, 3GB RAM and updated LAMP stack from [Bento](https://app.vagrantup.com/bento/boxes/debian-10).
